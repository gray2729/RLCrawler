...
ScoresFile = open("LearningScores.txt", "w")
ActionsFile = open("LearningActions.txt", "w")
...
for i in range(n_episodes):
    ...
    while done==False and timestep<max_episode_step:
        ...
        if (i+1)%episode_num==0:
            ActionsFile.write(str(action))
            if done != True:
                ActionsFile.write(" ")
